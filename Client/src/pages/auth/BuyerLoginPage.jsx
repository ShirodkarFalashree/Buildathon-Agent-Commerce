    ...
    <div className="min-h-screen bg-slate-950 flex flex-col justify-center items-center p-4">
      ...
      <div className="w-full max-w-md glass-panel p-8 rounded-3xl border border-indigo-500/30 shadow-2xl space-y-6 relative z-10">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold text-white tracking-tight">Buyer Account Sign-In</h1>
          <p className="text-xs text-slate-400">Log in to your AI-native shopping account & saved payment vault.</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4 text-xs">
          <div>
            <label className="block text-slate-300 font-semibold mb-1">Buyer Email Address</label>
            <input
              type="email"
              value={email}
