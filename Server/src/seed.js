...
const initialProducts = [
  ...
  {
    title: "NomadPro Anti-Theft Smart Travel Backpack with USB Charging Port",
    slug: "nomadpro-travel-backpack-usb",
    description:
      "Water-resistant TSA-friendly 35L travel backpack with built-in external USB charging port, anti-theft hidden zippers, and dedicated 16-inch padded laptop compartment.",
    category: "Travel",
    brand: "NomadGear",
    price: 4999,
    compareAtPrice: 7999,
    ...
    reviewCount: 420,
    features: [
      "Built-in USB charging port for on-the-go phone & device charging",
      "TSA-approved 180-degree lay-flat opening for airport security checkpoints",
      "Hidden anti-theft back pocket for passport and credit cards",
      "Ergonomic breathable mesh shoulder straps with luggage trolley strap",
    ],
    tags: [
      "backpack",
      "travel",
    ...
    specs: {
      capacity: "35 Liters",
      laptopSize: "Up to 16-inch",
      material: "1680D Ballistic Nylon",
      chargingPort: "USB-A & USB-C Passthrough",
      weight: "1.1kg",
    },
  },
  {
    title: "Anker 10,000mAh Magnetic Wireless Power Bank",
    slug: "anker-10k-power-bank",
    description:
      "Ultra-compact 10,000mAh portable charger with USB-C fast charging. Perfect companion for travel backpacks and long flights.",
    category: "Mobile",
    brand: "Anker",
    price: 2999,
    compareAtPrice: 4499,
    ...
    reviewCount: 310,
    features: [
      "Fast 20W USB-C Power Delivery charging for iPhone and Android",
      "Ultra-slim pocket size ideal for travel backpack USB pass-through ports",
      "MultiProtect safety system prevents overheating during flight travel",
    ],
    tags: [
      "power bank",
      "usb charger",
    ...
    imageUrl: "https://images.unsplash.com/photo-1609592424071-8b2b73715d02?q=80&w=800&auto=format&fit=crop",
    isActive: true,
    specs: {
      capacity: "10,000mAh",
      output: "20W USB-C PD",
